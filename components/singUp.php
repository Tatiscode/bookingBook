<!-- Section Design Block For Sign Up -->
    ...
    <div class="row gx-lg-5 align-items-center mb-5">
      <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
        <h1 class="my-5 display-5 fw-bold ls-tight" style="color: hsl(218, 81%, 95%)">
          ¡Registrate en Biblioteca Virtual!<br />
        </h1>
        ...
        <div class="card bg-glass">
          ...
          <div class="card-body px-4 py-5 px-md-5">
            <form onsubmit="return false" class="formulario_r">
              ...
              <!-- Submit button -->
              <button type="submit" class="enviarDatos">Registrase
              </button>


              <div class="text-center">
                <p> 
                  <a href="http://localhost/Biblioteca/views/login.php">Iniciar Sesión</a>
                </p>
              </div>
            </form>
          </div>
